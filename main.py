...
# Ensure directory exists for Qdrant data (used by local persistence)
...
def search_local_kb(query: str, top_k: int = 3) -> str:
    """
    Search the local knowledge base using Qdrant. Provide a query and optional top_k (default 3). Returns formatted snippets.
    """
